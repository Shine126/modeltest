#!/usr/bin/env python3
"""
Sekai 海外节点基准测试 — DeepSeek 模型
========================================
从北美/海外发起测试，测量 DeepSeek V4-Flash / V4-Pro 的真实链路性能。

用法:
  export DEEPSEEK_API_KEY="sk-xxx"
  python3 benchmark_sekai_overseas_deepseek.py
  python3 benchmark_sekai_overseas_deepseek.py --rounds 1
...
MODELS_CONFIG = {
    "deepseek-v4-flash": {
        ...
        "max_tokens": 16384,
        "cache_tokens_field": "prompt_cache_hit_tokens",
        "miss_tokens_field": "prompt_cache_miss_tokens",
    },
    "deepseek-v4-pro": {
        "api_url": "https://api.deepseek.com/chat/completions",
        "api_key_env": "DEEPSEEK_API_KEY",
...
def main():
    parser = argparse.ArgumentParser(description="Sekai 海外基准测试 — DeepSeek")
    ...
    output_file = args.output or f"overseas_deepseek_{timestamp}.json"
    output_path = Path(__file__).parent / "results" / "overseas" / "deepseek" / output_file
    output_path.parent.mkdir(parents=True, exist_ok=True)

    output_data = {
        "meta": {
            "test_type": "overseas_deepseek",
            "timestamp": timestamp,
